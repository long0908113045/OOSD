...
namespace QuanLiTrungTamAnhNgu
{
    ...
    public partial class EnglishCenterEntities : DbContext
    {
        ...
        public virtual int sp_SuaLevel(Nullable<int> idlv, string malv, string mota, string tenlv)
        {
            var idlvParameter = idlv.HasValue ?
                new ObjectParameter("idlv", idlv) :
                new ObjectParameter("idlv", typeof(int));
    
            var malvParameter = malv != null ?
                new ObjectParameter("malv", malv) :
                new ObjectParameter("malv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaLevel", idlvParameter, malvParameter, motaParameter, tenlvParameter);
        }
    
        public virtual int sp_ThemLevel(string malv, string tenlv, string mota)
        {
            var malvParameter = malv != null ?
                new ObjectParameter("malv", malv) :
                new ObjectParameter("malv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ThemLevel", malvParameter, tenlvParameter, motaParameter);
        }
        ...
        [DbFunction("EnglishCenterEntities", "fn_LoadLevel1")]
        public virtual IQueryable<fn_LoadLevel1_Result1> fn_LoadLevel1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_LoadLevel1_Result1>("[EnglishCenterEntities].[fn_LoadLevel1]()");
        }
        ...
        public virtual int sp_SuaNhanVien(Nullable<int> id_nv, string manv, string hoten, string chucvu, string email, string sdt, string cmnd, Nullable<System.DateTime> ngaysinh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaNhanVien", id_nvParameter, manvParameter, hotenParameter, chucvuParameter, emailParameter, sdtParameter, cmndParameter, ngaysinhParameter);
        }
    
        public virtual int sp_ThemNhanVien(string manv, string hoten, string chucvu, string email, string sdt, string cmnd, Nullable<System.DateTime> ngaysinh)
        {
            var manvParameter = manv != null ?
                new ObjectParameter("manv", manv) :
                new ObjectParameter("manv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ThemNhanVien", manvParameter, hotenParameter, chucvuParameter, emailParameter, sdtParameter, cmndParameter, ngaysinhParameter);
        }
        ...
        public virtual int sp_SuaKhoaHoc(Nullable<int> id_KH, string makh, string tenkh, string mota)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaKhoaHoc", id_KHParameter, makhParameter, tenkhParameter, motaParameter);
        }
    
        public virtual int sp_ThemKhoaHoc(string makh, string tenkh, string mota)
        {
            var makhParameter = makh != null ?
                new ObjectParameter("makh", makh) :
                new ObjectParameter("makh", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ThemKhoaHoc", makhParameter, tenkhParameter, motaParameter);
        }
        ...
        public virtual int sp_SuaLopHoc(string malh, string tenlh, Nullable<System.DateTime> thoigianbatdau, Nullable<System.DateTime> thoigianketthuc, Nullable<decimal> hocphi, Nullable<int> idnv, Nullable<int> idkh, Nullable<int> idlv, Nullable<int> sobuoihoc, string khunggiohoc)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaLopHoc", malhParameter, tenlhParameter, thoigianbatdauParameter, thoigianketthucParameter, hocphiParameter, idnvParameter, idkhParameter, idlvParameter, sobuoihocParameter, khunggiohocParameter);
        }
    
        public virtual int sp_ThemLopHoc(string malh, string tenlh, Nullable<System.DateTime> thoigianbatdau, Nullable<System.DateTime> thoigianketthuc, Nullable<decimal> hocphi, Nullable<int> idnv, Nullable<int> idkh, Nullable<int> idlv, Nullable<int> sobuoihoc, string khunggiohoc)
        {
            var malhParameter = malh != null ?
                new ObjectParameter("malh", malh) :
                new ObjectParameter("malh", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ThemLopHoc", malhParameter, tenlhParameter, thoigianbatdauParameter, thoigianketthucParameter, hocphiParameter, idnvParameter, idkhParameter, idlvParameter, sobuoihocParameter, khunggiohocParameter);
        }
        ...
        public virtual IQueryable<fn_ListLopHoc_Result1> fn_ListLopHoc()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ListLopHoc_Result1>("[EnglishCenterEntities].[fn_ListLopHoc]()");
        }
        ...
        public virtual int sp_SuaHocVien(Nullable<int> idhv, string mahv, string hoten, string diachi, string email, string sdt)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_SuaHocVien", idhvParameter, mahvParameter, hotenParameter, diachiParameter, emailParameter, sdtParameter);
        }
        ...
        public virtual IQueryable<fn_ListHocVien_Result1> fn_ListHocVien()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ListHocVien_Result1>("[EnglishCenterEntities].[fn_ListHocVien]()");
        }
        ...
        public virtual int sp_ThemHocVien(string mahv, string hoten, string diachi, string email, string sdt)
        {
            var mahvParameter = mahv != null ?
                new ObjectParameter("mahv", mahv) :
                new ObjectParameter("mahv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ThemHocVien", mahvParameter, hotenParameter, diachiParameter, emailParameter, sdtParameter);
        }
        ...
        public virtual IQueryable<fn_ListPhieuThu_Result2> fn_ListPhieuThu(Nullable<int> idlh)
        {
            var idlhParameter = idlh.HasValue ?
                new ObjectParameter("idlh", idlh) :
                new ObjectParameter("idlh", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ListPhieuThu_Result2>("[EnglishCenterEntities].[fn_ListPhieuThu](@idlh)", idlhParameter);
        }
