...
namespace QuanLiTrungTamAnhNgu
{
    public partial class frNhanVien : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void bttThemNV_Click(object sender, EventArgs e)
        {
            ...
            //if (txtMaNV.Text.Replace(" ", "") != "" && txtHoTenNV.Text.Replace(" ", "") != "" && txtSoDienThoaiNV.Text.Replace(" ", "") != "" && txtCMND.Text.Replace(" ", "") != "")
            //{
            ...
            //    {
            //        BuilderPattern.NhanVien nhanVien = new BuilderPattern.NhanVien();
        ...
        {
            //if (txtMaNV.Text.Replace(" ", "") != "" && txtHoTenNV.Text != "" && txtEmailNV.Text != "" && txtSoDienThoaiNV.Text != "" && txtCMND.Text != "" && cbxChucVu.Text != "")
            //{
            ...
            //    if (dialogResult == DialogResult.Yes)
            //    {
            //        if (context.sp_SuaNhanVien(idnv, manv, hoten, chucvu, email, sdt, cmnd, ngaysinh) !=0)
            //        {
        ...
        {
            //int idnv = Convert.ToInt32(gvNhanVien.GetRowCellValue(gvNhanVien.FocusedRowHandle, gvNhanVien.Columns[0]).ToString());
            //if (txtMaNV.Text.Replace(" ", "") != "" && txtHoTenNV.Text.Replace(" ", "") != "" && txtSoDienThoaiNV.Text.Replace(" ", "") != "" && txtCMND.Text.Replace(" ", "") != "" && cbxChucVu.Text.Replace(" ", "") != "" && txtEmailNV.Text.Replace(" ", "") != "")
            //{
        ...
        private void gvNhanVien_Click(object sender, EventArgs e)
        {
            ...
            //    txtMaNV.EditValue = gvNhanVien.GetRowCellValue(gvNhanVien.FocusedRowHandle, gvNhanVien.Columns[1]).ToString();
        ...
        {
            //gcNhanVien.DataSource = context.fn_ListNhanVien();
